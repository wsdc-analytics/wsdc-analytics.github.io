...
def replace_body_copy(html: str, t: dict) -> str:
    ...
    pairs = [
        ...
        (
            "Большинство танцоров с поинтами на этом ивенте отметились в реестре разово: 63% (865 из 1364)\n        набирали поинты только один раз. На них приходится 39,4% всех поинтов Skill Level.\n        Ниже: как распределяются танцоры с большим количеством успешных участий и какая доля поинтов у этих групп.",
            t["ret_p1"],
        ),
        (
